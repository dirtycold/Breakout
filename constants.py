...
REWARD_TRIGGER_PROBABILITY = 1.0
REWARD_SIZE = 18
REWARD_RADIUS = REWARD_SIZE / 2
REWARD_INITIAL_SPEED_X = 90
REWARD_INITIAL_SPEED_Y = 180  # Arcade 正向向上；QML 会取反 / Upward in Arcade; negated in QML
REWARD_GRAVITY = 520
REWARD_FIREBALL_COLOR = (239, 68, 68)  # #EF4444
REWARD_FIREBALL_BORDER_COLOR = (251, 146, 60)  # #FB923C
REWARD_FIREBALL_COLOR_HEX = "#EF4444"
REWARD_FIREBALL_BORDER_COLOR_HEX = "#FB923C"
REWARD_FIREBALL_SYMBOL = "F"
FIREBALL_PATH_EXTRA_BRICKS = 3
FIREBALL_PATH_WIDTH = 38
